...
<html lang="en">
    ...
    <header>
        ...
        <main>
            ...
            ?>
            <table class="banhDanhSachSinhVien">
                ...
                <?php
                    while($row = mysqli_fetch_array($ThongTinPhieuTiepNhanTT)){
                        $thongTinSinhVien = infSinhVien($row['MSSV']);
                        echo '<tr>
                                ...
                                <td><a class="NutXemGiayGioiThieu" href="../SinhVien/NopCV/GiayGioiThieu.php?ID='.$thongTinSinhVien['MSSV'].'">Chi tiết giấy<br>giới thiệu</a></td>';
                                echo '<td>';
                                    if(KiemTraSV_DuocNhanThucTapTaiDonVi($thongTinSinhVien['MSSV']) == 1){
                                        echo '<a class="NutXemThongTinTiepNhanThucTap" href="../SinhVien/NopPhieuTiepNhanChoGVHD/ChuanBiNopPhieu.php?ID='.$thongTinSinhVien['MSSV'].'&Role='.$role['UserRole'].'">Chi tiết phiếu <br>tiếp nhận thực tập.</a>';
                                    }else{
