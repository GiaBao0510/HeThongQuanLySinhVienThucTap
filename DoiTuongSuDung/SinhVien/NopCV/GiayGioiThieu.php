    ...
    <body>
        ...
        <main>
            <?php
                ...
                //ĐK: Nếu sinh viên chưa đăng ký thực tạp thì không thể xem
                if(KiemTraSinhVien_DangKyThucTapHayChua($MaSSV) < 1){
                    echo "<script>
                            alert('Sinh Viên chưa đăng ký thực tập. Nên không thể xem giấy giới thiệu');
                            history.back();
                        </script>";
                }else{
