...
<html lang="en">
    ...
    <h1 class="BangLietKe">Bảng Phiếu giao việc cho sinh viên thực tập thực tế</h1>
    <table id="CanChinhBangPGVSV" class="table table-striped BangPhieu">
            <thead>
                <tr class="TieuDeBangPhieu">
                    <th>Mã số phiếu giao việc sinh viên</th>
