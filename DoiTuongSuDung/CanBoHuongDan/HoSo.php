        ...
        <header>
            <div class="DauTrang">
                ...
                <div class="CacNut">
                    ...
                    <a href="TrangChuSinhVien.php?ID=<?php echo strval($_POST['MSCB']) ;?>" class="NutTrangChu"><i class="fa-solid fa-house"></i>Trang chủ</a>
                </div>
            </div>
        </header>
        <main> 
                        ...
                        <table class="ThongTin_phai">
                            <tr>
                                <td colspan="2"  class="CotBenTrai">
                                    <p class="TieuDeChinhSua">CHỈNH SỬA HỒ SƠ CÁN BỘ HƯỚNG DẪN</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p class="ThongTinChinhSua">'.$_POST['MSCB'].'</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                ...
                                <td>
                                    <p class="ThongTinChinhSua">'.$_POST['TenDVTT'].'</p>
                                </td>
                            </tr>
                            <tr>
                                <td>
