<?php
    ...
    function IncreaseIDIndex($Ma){
        $Ma = trim($Ma);
        // echo "<p>".$Ma." Type: ". gettype($Ma) ."</p>";
        // echo "<p>Lấy chữ số cuối chuỗi:". LayChuoiSoCuoiChuoi($Ma) ."</p>";
        // echo "<p>Lấy chữ cái đầu chuỗi:". LayChuoiChuCaiDau($Ma) ."</p>";
        // echo "<p>Tăng giá trị cuối chuỗi:". IndexIncrease(LayChuoiSoCuoiChuoi($Ma)) ."</p>";
        // echo "<p>Mới:". strval( LayChuoiChuCaiDau($Ma).IndexIncrease(LayChuoiSoCuoiChuoi($Ma)) ) ."</p>";
